    ...
    return (
        ...
        <div className="d-flex justify-content-center row mt-5" >
            <div className="col-md-6 col-sm-12 my-4" >
                ...
                <div className="row col-sm-12" style={{ backgroundColor: "rgba(185, 185, 187, 0.366)", borderRadius: "0px" }}>
                    ...
                    <div className="row col-md-12 col-sm-12">
                        <div className="col-md-12 col-sm-12 d-flex flex-column align-items-center pt-1" >
                            <form onSubmit={handlesubmit} className="text-center col-md-10 col-sm-12 mx-auto" >
                                <div className=" mb-3" >
                        ...
                        <div className="d-flex justify-content-center py-3">
                            <Link to="/">
                                <button type="button" className="buttonHomeCP-Volver">
                                    Volver a Inicio
                                </button>
                            </Link>
                        </div>
