    ...
    return (
        // <div className="account-pages1" >
            <div className="account-pages pt-2 pt-sm-5 pb-4 pb-sm-5" >
                <div className="RegistroProyecto center-content pt-2 text-center bg-primary card-header col-md-6" style={{ color: 'white' }} width-400px>

                    <div className="content-container col-md-6 m-auto">
                        <div className="d-flex justify-content-center">
                            <h1>{id ? "Editar Especialista" : "Registrar Nuevo Especialista"}</h1>
                        </div>
                        <div className="containerSpecialist" style={{ color: 'black' }} width-400px>
                            <div className="mb-3">
